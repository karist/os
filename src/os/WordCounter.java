...
class Docs {
    private final List<Docs> subFolders;
    private final List<Document> documents;
    
    Docs(List<Docs> subFolders, List<Document> documents) {
        this.subFolders = subFolders;
        this.documents = documents;
    }
    
    List<Docs> getSubFolders() {
    ...
    static Docs fromDirectory(File dir) throws IOException {
        List<Document> documents = new LinkedList<>();
        List<Docs> subFolders = new LinkedList<>();
        for (File entry : dir.listFiles()) {
            if (entry.isDirectory()) {
                subFolders.add(Docs.fromDirectory(entry));
            } else {
                documents.add(Document.fromFile(entry));
            }
        }
        return new Docs(subFolders, documents);
    }
}
...
/* ......................................................................................... */
    ...
    Long countOccurrencesOnSingleThread(Docs folder, String searchedWord) {
        long count = 0;
        for (Docs subFolder : folder.getSubFolders()) {
...
/* ......................................................................................... */
    ...
    class FolderSearchTask extends RecursiveTask<Long> {
        private final Docs folder;
        private final String searchedWord;
        
        FolderSearchTask(Docs folder, String searchedWord) {
            super();
            this.folder = folder;
            this.searchedWord = searchedWord;
        }
...
/* ......................................................................................... */
    ...
    Long countOccurrencesInParallel(Docs folder, String searchedWord) {
...
//        Folder folder = Folder.fromDirectory(new File(args[0]));
        Docs folder = Docs.fromDirectory(new File("E:\\arsendi\\Documents\\Mine\\Reff OS"));
